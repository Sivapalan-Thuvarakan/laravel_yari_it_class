...
<body>
    <h1 style="color:red;text-align:center;margin:50px;"> Edit <small class="text-muted">Subject</small></h1>
...
<form  action="{{route('subjects.update',$subject->id)}}" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-row">
        <div class="col-md-6">
            ...
            <input type="text" name="name" id="name" class="form-control"  placeholder="Subject Name" value="{{$subject->name}}">
        </div>
    </div>
